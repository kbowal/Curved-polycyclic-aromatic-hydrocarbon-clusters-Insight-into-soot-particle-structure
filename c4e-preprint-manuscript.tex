...
However, neighbouring corannulene molecules within the heterogeneous cluster do not tend to interact in a stacked order, although the spacing does decrease with an increased proportion of 2pent15ring molecules present (comparing two30ann10 to two10ann30). % why is two20ann20 0.55ish when 50/50 is 0.45ish?? Check that data file!!
% also how can the 30/10 cases have averages below and above their individual parts?
%
\begin{table}[]
\centering
...
The intermolecular energies as a function of cluster mass are shown in Figure XXX.  The energies are shown per atom in the system, in order to facilitate direct comparison between systems of different cluster and molecule sizes.
